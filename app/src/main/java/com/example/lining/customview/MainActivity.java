...
public class MainActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        //设置点击事件
        icon_home.setOnClickListener(mMyOnClickListener);
        icon_menu.setOnClickListener(mMyOnClickListener);
        level3.setOnClickListener(mMyOnClickListener);
        level2.setOnClickListener(mMyOnClickListener);
        level1.setOnClickListener(mMyOnClickListener);
